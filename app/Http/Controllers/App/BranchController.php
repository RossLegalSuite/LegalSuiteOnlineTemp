...
class BranchController extends Controller {
    ...
    public function get_Ettorney(Request $request)
    {
        ...
        if ($request->id) $query->where('branches.id',$request->id);

        if ($request->code) $query->where('branches.code',$request->code);

        if ($request->description) $query->where('branches.description',$request->description);
    ...
    public function store_Ettorney(Request $request)
    {
        ...
        if ( isset($request->id) )$rules['code'] = ['required',Rule::unique('branches')->ignore($request->id)];
