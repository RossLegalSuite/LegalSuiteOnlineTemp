...
class CreditorNumberController extends Controller {
    ...
    public function getByType(Request $request)
    {
        ...
        if ($request->orderBy) $query->orderBy('description');
    ...
    public function store(Request $request)
    {
        ...
        if ($request->defaultFlag === '1') $this->clearOtherDefaultFlags($request->creditorId, $contactMethod->id);
