...
export default {
    ...
    methods: {
        ...
        primeFilter(filterName, filterColumn) {
            ...
            let dateFilter = this.$parent.getFilter(filterName);
            ...
            if ( dateFilter ) {
                ...
                this.fromDate = dateFilter.settings.fromDate;
                this.toDate = dateFilter.settings.toDate;
                this.currentPeriod = this.period = dateFilter.settings.period;

            } else {
                
                this.clearIcon = false;

                this.currentPeriod = this.period = null;
                this.fromDate = null;
                this.toDate = null;
            }
