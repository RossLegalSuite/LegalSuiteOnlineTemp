                ...
                <div class="modal-body p-3" style="min-height: 45vh; max-height: 75vh; overflow-y: auto;">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <pop-over content="
                                <h4>Column</h4>
                                <p>Select a Column to filter by.</p>"
                            />
                    ...
                    <div v-show="tableColumn && tableColumn.filterControl === 'Lookup'" class="form-group row">
                        ...
                        <select-doclog-category v-show="tableColumn && tableColumn.filterTable === 'DoclogCategory'" :error="errorValue" :id="id + '-select-doclog-category'" :ref="id + '-select-doclog-category'" :formRef="id + '-select-doclog-category'"/>

                        <select-doclog-sub-category v-show="tableColumn && tableColumn.filterTable === 'DoclogSubCategory'" :error="errorValue" :id="id + '-select-doclog-sub-category'" :ref="id + '-select-doclog-sub-category'" :formRef="id + '-select-doclog-sub-category'"/>
...
export default {
    ...
    watch: {
        ...
        tableColumn() {
            ...
            if (this.tableColumn.filterType === 'String' ) {
            ...
            } else if (this.tableColumn.filterTable === 'DoclogCategory') {

                if ( this.addingNewRecord ) this.record.value = null;

                if ( this.record.value ) this.selectDocLogCategory.record = root.doclogCategories.filter(record => record.description === this.record.value)[0];

            } else if (this.tableColumn.filterTable === 'DoclogSubCategory') {

                if ( this.addingNewRecord ) this.record.value = null;

                if ( this.record.value ) this.selectDocLogSubCategory.record = root.doclogSubCategories.filter(record => record.description === this.record.value)[0];
                ...
                if ( this.addingNewRecord ) this.record.value = root.loggedInEmployeeName;
    ...
    methods: {
        ...
        saveFilter( refreshModal = true ) {
            ...
            if (this.tableColumn.filterType == 'Dropdown') {

                this.record.description = this.record.filterTitle + ' equals ' + this.tableColumn.filterOptions.filter(record => record.value == this.record.value)[0].label;
        ...
        matterSelected( selectedRecord ) {
            this.record.value = selectedRecord.fileref;
        },

        partySelected( selectedRecord ) {
            this.record.value = selectedRecord.matterprefix;
        },
        ...
        employeeSelected( selectedRecord ) {
            this.record.value = selectedRecord.name;
        },
