        ...
        <div class="modal-dialog modal-dialog-centered modal-lgr">
            ...
            <div class="modal-body" style="height:75vh; overflow: unset">
                ...
                <div class="form-group row">
                    ...
                    <div v-if="!mailMergeFlag" class="col-md-8">
...
export default {
    ...
    methods: {
        ...
        changeTemplate() {
            ...
            root.selectTemplate.load(this, 'Email', this.templateRecord.source);
        ...
        templateSelected(id) {
            ...
            .then(response => {
                ...
                if ( response.data.errors ) {
                    ...
                    this.templateRecord = response.data.data[0];
        ...
        setDefaultTemplate( id ) {
            ...
            if ( this.templateRecord.source == 'Party' ) {
                root.lolSettings.partiesemailtemplateid = id;
            } else if ( this.templateRecord.source == 'MatParty' ) {
                root.lolSettings.matpartiesemailtemplateid = id;
            }
