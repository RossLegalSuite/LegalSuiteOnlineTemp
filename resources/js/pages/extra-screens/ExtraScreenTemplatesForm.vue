                    ...
                    <div class="col-md-12">
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                ...
                                <!-- <button class="btn btn-success btn-sm d-inline-block mr-2" @click="viewFieldList" title="View the fields that can be inserted into this Document"><i class="fa fa-code mr-2"></i>View Fields</button> -->
...
export default {
    ...
    methods: {
        ...
        async testMerge() {
            ...
            if ( this.$parent.record.location === 'Matter' || this.$parent.record.location === 'Document Set' || this.$parent.record.location === 'Matter Type') {

                this.dataSource = 'Matters';
                this.selectMatter.selectMatter(this);

            } else if ( this.$parent.record.location === 'Party' || this.$parent.record.location === 'Party Entity' || this.$parent.record.location === 'Party Type') {
                
                this.dataSource = 'Parties';
                this.selectParty.selectParty(this);

            } else if ( this.$parent.record.location === 'Party Role') {

                this.dataSource = 'Party Roles';
                this.selectMatterParty.selectMatterParty(this);
            }
        ...
        okClicked( closeForm = true ) {
            ...
            let source = { source: this.dataSource};

            axios.post('/document_templates/store',  { ...this.record, ...source })
