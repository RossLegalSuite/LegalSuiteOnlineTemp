    ...
    <div class="modal-dialog modal-dialog-left modal-lg">
        ...
        <div class="modal-content" style="border-color:indianred">
            ...
            <div class="modal-header indianred">
                <h2 class="modal-title page-title"><i class="fa fa-server mr-2"></i>Select Matter Parties</h2>
                <i title="Close this window" class="cp top-right fa fa-times-circle fa-2x text-white" data-dismiss="modal"></i>
            </div>

            <div class="modal-body p-3" style="height: 60vh; overflow-y: auto;">

                <select-matter-parties-table 
                    :tableId="id + '-matter-parties-table'" 
                    :lazyLoadFlag="true" 
                    :tagging="true" 
                    :ref="id + '-select-matter-parties-table'" 
                    :formRef="id + '-select-matter-parties-table'"
                />
...
export default {
    ...
    components: {
        SelectMatterPartiesTable: () => import("./SelectMatterPartiesTable"),
    },
    ...
    mounted () {
        this.$parent.selectMatterParties = this;
    },    
    ...
    methods: {
        ...
        selectClicked() {
            ...
            if ( this.selectedAllFlag ) {
                ...
                this.$parent.matterPartiesSelected([], this.table);
            
            } else {
                
                this.$parent.matterPartiesSelected(this.selectedRows);
