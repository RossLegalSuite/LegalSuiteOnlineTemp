...
<div :class="formControls ? _class : ''">
    ...
    <div v-show="formControls">
        ...
        <div class="input-group">
            <select-doclog-sub-category-dropdown
                :id="id + '-select-doclog-sub-category-dropdown'"
                ...
                :allow-empty="false"
                :show-labels="false"
                @input="doclogSubCategorySelected"
            >
            ...
            <div v-if="!readOnly" class="input-group-append">
                <button
                    tabindex="-1"
                    v-on:click="selectDoclogSubCategory"
                    type="button"
        ...
        <div class="modal-dialog modal-dialog-left">
            ...
            <div class="modal-content" style="border-color:indianred">
                ...
                <div class="modal-body p-3" style="height: 60vh; overflow-y: auto;">
                    ...
                    <doclog-sub-category-table
                    :options-button="false"
                    :new-record-button="true"
                    :table-id="id + '-table'"
                    :lazyLoadFlag="true"
                    ref="select-doclog-sub-category-table"
                    :formRef="formRef"
                    />
...
export default {
    ...
    components: {
        DoclogSubCategoryTable: () => import("./DoclogSubCategoryTable"),
        SelectDoclogSubCategoryDropdown: Multiselect
    },

    props: {
        clearIconCallback: { type: String, default: 'clearSelectDoclogSubCategory' },
        clearIcon: { type: Boolean, default: false },
        title: {
            type: String,
            default: 'Click on the button to select a Sub Category',
        }, 
        _class: {
            type: String, 
            default: 'col-md-12',
    ...
    mounted () {
        this.$parent.selectDoclogSubCategory = this;
    },    
    ...
    methods: {
        ...
        doclogSubCategorySelected(selectedRecord) {
            ...
            if ( typeof this.$parent.doclogSubCategorySelected === 'function') this.$parent.doclogSubCategorySelected(selectedRecord);

        },        

        selectRecord(id) {

            this.doclogSubCategorySelected( this.table.table.row('#' + id).data() );
