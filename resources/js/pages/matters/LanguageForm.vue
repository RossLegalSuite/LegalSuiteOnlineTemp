...
<div :id="id" :class="modal ? 'modal': ''">
    ...
    <div :class="modal ? 'modal-dialog modal-dialog-centered' : ''">
        ...
        <div :class="modal ? 'modal-content steelblue-border':'card h-100 border-0'">
            ...
            <div :class="modal ? '':'card-header'">
                ...
                <div :class="modal ? 'modal-header steelblue' : 'd-flex justify-content-between'">
                    ...
                    <div class="page-title">
                        <h3>
                            <span v-if="!editing">Language will be Added</span>
                            <span v-else-if="viewing">Language</span>
                            <span v-else>Language will be Changed</span>
                        </h3>
            ...
            <form-buttons :editing="editing" record="Language" @ok-clicked="okClicked" @cancel-clicked="closeForm" @delete-clicked="deleteClicked"/>
...
export default {
    ...
    props: {
        resource: {type: String, default: 'Languages' },
    },
    ...
    methods: {
        ...
        selectRecord(id) {
            ...
            axios.post('/generic/get',{recordid: id, tableName: 'language'}).then(response => {

                if ( typeof this.$parent.languageSelected === 'function') this.$parent.languageSelected(response.data.data[0]);
        ...
        okClicked() {
            ...
            axios.post('/generic/store', {...this.record, tableName: 'language'})
        ...
        highlightTableRow( id, description ) {
            ...
            axios.post('/generic/getTablePosition', { description: description, tableName: 'language'  })
