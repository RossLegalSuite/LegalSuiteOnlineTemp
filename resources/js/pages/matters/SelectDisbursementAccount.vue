...
<div :class="formControls ? _class : ''">
    ...
    <div v-show="formControls">
        ...
        <div class="input-group">
            <select-disbursement-account-dropdown
                :id="id + '-select-disbursement-account-dropdown'"
                :class="error[0] ? 'multiselect-invalid-feedback' : ''"
                openDirection="below"
                placeholder=""
                :options="$root.disbursementAccounts" 
                v-model="record"
                track-by="recordid"
                :tabindex="-1"
                label="description"
            ...
            >
            <template slot="noResult">No Disbursement Accounts found</template>
            <template slot="noOptions">No Disbursement Accounts found...</template>
            ...
            <div v-if="!readOnly" class="input-group-append">
                <button
                    tabindex="-1"
                    v-on:click="selectDisbursementAccount"
                    type="button"
        ...
        <div class="modal-dialog modal-dialog-left">
            ...
            <div class="modal-content" style="border-color:indianred">
                ...
                <div class="modal-body p-3" style="height: 60vh; overflow-y: auto;">
                    ...
                    <disbursement-account-table
                    :options-button="false"
                    :table-id="id + '-table'"
                    :lazyLoadFlag="true"
                    ref="select-disbursement-account-table"
                    :formRef="formRef"
                    />
...
export default {
    ...
    components: {
        DisbursementAccountTable: () => import("./DisbursementAccountTable"),
        SelectDisbursementAccountDropdown: Multiselect
    },

    props: {
        clearIconCallback: { type: String, default: 'clearSelectDisbursementAccount' },
        clearIcon: { type: Boolean, default: false },
        title: {
            type: String,
            default: 'Click on the button to select an Account',
        }, 
        _class: {
            type: String, 
            default: 'col-md-12',
    ...
    mounted () {
        this.$parent.selectDisbursementAccount = this;
    },    
    ...
    methods: {
        ...
        recordSelected(selectedRecord) {
            ...
            if ( typeof this.$parent.disbursementAccountSelected === 'function') this.$parent.disbursementAccountSelected(selectedRecord.recordid, selectedRecord.description);
