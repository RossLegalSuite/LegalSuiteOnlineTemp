...
<div :class="formControls ? _class : ''">
    ...
    <div v-show="formControls">
        ...
        <div class="input-group">
            <select-revenue-stamp-account-dropdown
                :id="id + '-select-revenue-stamp-account-dropdown'"
                :class="error[0] ? 'multiselect-invalid-feedback' : ''"
                openDirection="below"
                placeholder=""
                :options="$root.revenueStampAccounts" 
                v-model="record"
                track-by="recordid"
                :tabindex="-1"
                label="description"
            ...
            >
            <template slot="noResult">No Revenue Stamp Accounts found</template>
            <template slot="noOptions">No Revenue Stamp Accounts found...</template>
            ...
            <div v-if="!readOnly" class="input-group-append">
                <button
                    tabindex="-1"
                    v-on:click="selectRevenueStampAccount"
                    type="button"
        ...
        <div class="modal-dialog modal-dialog-left">
            ...
            <div class="modal-content" style="border-color:indianred">
                ...
                <div class="modal-body p-3" style="height: 60vh; overflow-y: auto;">
                    ...
                    <revenue-stamp-account-table
                    :options-button="false"
                    :table-id="id + '-table'"
                    :lazyLoadFlag="true"
                    ref="select-revenue-stamp-account-table"
                    :formRef="formRef"
                    />
...
export default {
    ...
    components: {
        RevenueStampAccountTable: () => import("./RevenueStampAccountTable"),
        SelectRevenueStampAccountDropdown: Multiselect
    },

    props: {
        clearIconCallback: { type: String, default: 'clearSelectRevenueStampAccount' },
        clearIcon: { type: Boolean, default: false },
        title: {
            type: String,
            default: 'Click on the button to select an RevenueStamp Account',
        }, 
        _class: {
            type: String, 
            default: 'col-md-12',
        ...
        plural: {
            type: String,
            default: 'Revenue Stamp Accounts',
        },
        formRef: String,
        formControls: {
            type: Boolean,
    ...
    mounted () {
        this.$parent.selectRevenueStampAccount = this;
    },    
    ...
    methods: {
        ...
        recordSelected(selectedRecord) {
            ...
            if ( typeof this.$parent.revenueStampAccountSelected === 'function') this.$parent.revenueStampAccountSelected(selectedRecord.recordid, selectedRecord.description);
