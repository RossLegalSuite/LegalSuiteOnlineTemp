...
<div :class="formControls ? _class : ''">
    ...
    <div v-show="formControls">
        ...
        <div class="input-group">
            <select-income-account-dropdown
                :id="id + '-select-income-account-dropdown'"
                :class="error[0] ? 'multiselect-invalid-feedback' : ''"
                openDirection="below"
                placeholder=""
                :options="$root.incomeAccounts" 
                v-model="record"
                track-by="recordid"
                :tabindex="-1"
                label="description"
            ...
            >
            <template slot="noResult">No Income Accounts found</template>
            <template slot="noOptions">No Income Accounts found...</template>
            ...
            <div v-if="!readOnly" class="input-group-append">
                <button
                    tabindex="-1"
                    v-on:click="selectIncomeAccount"
                    type="button"
        ...
        <div class="modal-dialog modal-dialog-left">
            ...
            <div class="modal-content" style="border-color:indianred">
                ...
                <div class="modal-body p-3" style="height: 60vh; overflow-y: auto;">
                    ...
                    :table-id="id + '-table'"
                    :lazyLoadFlag="true"
                    ref="select-income-account-table"
                    :formRef="formRef"
                    />
...
export default {
    ...
    components: {
        IncomeAccountTable: () => import("./IncomeAccountTable"),
        SelectIncomeAccountDropdown: Multiselect
    },

    props: {
        clearIconCallback: { type: String, default: 'clearSelectIncomeAccount' },
        clearIcon: { type: Boolean, default: false },
        title: {
            type: String,
            default: 'Click on the button to select an Income Account',
        }, 
        _class: {
            type: String, 
            default: 'col-md-12',
    ...
    mounted () {
        this.$parent.selectIncomeAccount = this;
    },    
    ...
    methods: {
        ...
        recordSelected(selectedRecord) {
            ...
            if ( typeof this.$parent.incomeAccountSelected === 'function') this.$parent.incomeAccountSelected(selectedRecord.recordid, selectedRecord.description);
