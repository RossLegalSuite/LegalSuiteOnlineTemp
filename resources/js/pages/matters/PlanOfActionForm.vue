...
<div :id="id" :class="modal ? 'modal': ''">
    ...
    <div :class="modal ? 'modal-dialog modal-dialog-centered' : ''">
        ...
        <div :class="modal ? 'modal-content steelblue-border':'card h-100 border-0'">
            ...
            <div :class="modal ? '':'card-header'">
                ...
                <div :class="modal ? 'modal-header steelblue' : 'd-flex justify-content-between'">
                    ...
                    <div class="page-title">
                        <h3>
                            <span v-if="!editing">Plan Of Action will be Added</span>
                            <span v-else-if="viewing">Plan Of Action</span>
                            <span v-else>Plan Of Action will be Changed</span>
                        </h3>
            ...
            <form-buttons :editing="editing" record="PlanOfAction" @ok-clicked="okClicked" @cancel-clicked="closeForm" @delete-clicked="deleteClicked"/>
...
export default {
    ...
    props: {
        resource: {type: String, default: 'Plan Of Actions' },
    },
    ...
    methods: {
        ...
        selectRecord(id) {
            ...
            axios.post('/generic/get',{recordid: id, tableName: 'planofaction'}).then(response => {

                if ( typeof this.$parent.PlanOfActionSelected === 'function') this.$parent.PlanOfActionSelected(response.data.data[0]);
        ...
        okClicked() {
            ...
            axios.post('/generic/store', {...this.record, tableName: 'planofaction'})
        ...
        highlightTableRow( id, description ) {
            ...
            axios.post('/generic/getTablePosition', { description: description, tableName: 'planofaction'  })
