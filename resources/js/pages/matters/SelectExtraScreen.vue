...
export default {
    ...
    methods: {
        ...
        selectExtraScreen() {
            ...
            if ( this.screenType == 'M' ) {
                this.table.whereRaw = "screenType = 'M'"
            } else {
        ...
        extraScreenSelected(selectedRecord) {
            ...
            if ( typeof this.$parent.extraScreenSelected === 'function') this.$parent.extraScreenSelected(selectedRecord.recordid, selectedRecord.description);
