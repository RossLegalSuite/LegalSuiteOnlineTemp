...
<div :class="formControls ? _class : ''">
    ...
    <div v-show="formControls">
        ...
        <div class="input-group">
            <select-expense-account-dropdown
                :id="id + '-select-expense-account-dropdown'"
                :class="error[0] ? 'multiselect-invalid-feedback' : ''"
                openDirection="below"
                placeholder=""
                :options="$root.expenseAccounts" 
                v-model="record"
                track-by="recordid"
                :tabindex="-1"
                label="description"
            ...
            >
            <template slot="noResult">No Expense Accounts found</template>
            <template slot="noOptions">No Expense Accounts found...</template>
            ...
            <div v-if="!readOnly" class="input-group-append">
                <button
                    tabindex="-1"
                    v-on:click="selectExpenseAccount"
                    type="button"
        ...
        <div class="modal-dialog modal-dialog-left">
            ...
            <div class="modal-content" style="border-color:indianred">
                ...
                <div class="modal-body p-3" style="height: 60vh; overflow-y: auto;">
                    ...
                    :table-id="id + '-table'"
                    :lazyLoadFlag="true"
                    ref="select-expense-account-table"
                    :formRef="formRef"
                    />
...
export default {
    ...
    components: {
        ExpenseAccountTable: () => import("./ExpenseAccountTable"),
        SelectExpenseAccountDropdown: Multiselect
    },

    props: {
        clearIconCallback: { type: String, default: 'clearSelectExpenseAccount' },
        clearIcon: { type: Boolean, default: false },
        title: {
            type: String,
            default: 'Click on the button to select an Expense Account',
        }, 
        _class: {
            type: String, 
            default: 'col-md-12',
    ...
    mounted () {
        this.$parent.selectExpenseAccount = this;
    },    
