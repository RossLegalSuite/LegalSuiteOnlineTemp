...
<div :class="formControls ? _class : ''">
    ...
    <div v-show="formControls">
        ...
        <div class="input-group">
            <select-plan-of-action-dropdown
                :id="id + '-select-plan-of-action-dropdown'"
                :class="error[0] ? 'multiselect-invalid-feedback' : ''"
                openDirection="below"
                placeholder=""
                :options="$root.planOfActions" 
                v-model="record"
                track-by="recordid"
                :tabindex="-1"
                label="description"
                ...
                :allow-empty="false"
                :show-labels="false"
                @input="planOfActionSelected"
            >
            <template slot="noResult">No Plan Of Actions found</template>
            <template slot="noOptions">No Plan Of Actions found...</template>
        ...
        <div class="modal-dialog modal-dialog-left">
            ...
            <div class="modal-content" style="border-color:indianred">
                ...
                <div class="modal-body p-3" style="height: 60vh; overflow-y: auto;">
                    ...
                    <plan-of-action-table
                    :options-button="false"
                    :table-id="id + '-table'"
                    :lazyLoadFlag="true"
                    ref="select-plan-of-action-table"
                    :formRef="formRef"
                    />
...
export default {
    ...
    components: {
        PlanOfActionTable: () => import("./PlanOfActionTable"),
        SelectPlanOfActionDropdown: Multiselect
    },

    props: {
        clearIconCallback: { type: String, default: 'clearSelectPlanOfAction' },
        clearIcon: { type: Boolean, default: false },
        title: {
            type: String,
            default: 'Click on the button to select a Plan Of Action',
        }, 
        _class: {
            type: String, 
            default: 'col-md-12',
    ...
    mounted () {
        this.$parent.selectPlanOfAction = this;
    },    
    ...
    methods: {
        ...
        planOfActionSelected(selectedRecord) {
            ...
            if ( typeof this.$parent.planOfActionSelected === 'function') this.$parent.planOfActionSelected(selectedRecord.recordid, selectedRecord.description);
        ...
        selectRecord(id) {
            ...
            this.planOfActionSelected( this.table.table.row('#' + id).data() );
